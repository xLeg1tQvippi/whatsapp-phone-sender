...
class Menu(QWidget):
    ...
    def check_pass(self):
        ...
        if active_nums == 'phone_numbers = []':
            ...
            self.label.setText('<center>Список с номерами пуст.<br>Добавьте номера для расссылки.</center>')
    ...
    def send_num(self):
        ...
        self.hide()
        sender = self.send_num = sender_withPyQt.Sender_Message(num_amount)
        self.show()
